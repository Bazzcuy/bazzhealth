...
import { ArrowLeft, ShoppingBag, Star, Shield, Truck, ChevronMinus, ChevronPlus, Package, Tag } from 'lucide-react';
...
export default function ProductDetail({ params }: { params: { id: string } }) {
  ...
  if (!product) {
    return (
      <main className="min-h-screen bg-[#F8FAFC] flex flex-col items-center justify-center gap-4 font-sans">
        <p className="text-slate-500 text-lg">Produk tidak ditemukan.</p>
        <Link href="/" className="text-[#23A455] font-bold hover:underline">Kembali ke Beranda</Link>
      </main>
    );
  }
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-0 border border-slate-200 rounded-xl overflow-hidden">
                ...
                >
                  <ChevronMinus className="w-4 h-4" />
                </button>
